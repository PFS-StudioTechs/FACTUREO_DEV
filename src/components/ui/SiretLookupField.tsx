    ...
    fetch(
      ...
      .then(json => {
        ...
        const siretMatch =
          ...
          result?.matching_etablissements?.some((e: unknown) => (e as { siret: string }).siret === digits);
        ...
        if (onResolved) {
          ...
          const adresse = voieComplete || siege.adresse || "";

          onResolved({ nom: denomination, denomination, adresse, code_postal: cp, ville });
        }
      })
      .catch(err => {
